...
public class CasiDuso {
    ...
    public static void UC7() {
        Cliente cliente;
        System.out.println("Inserisci cliente a cui vuoi aggiungere i punti:\n" +
                "Nome: ");
        String nome = scan.nextLine();
        System.out.println("Cognome:");
        String cognome = scan.nextLine();
        System.out.println("Email:");
        String email = scan.nextLine();
        cliente = org.example.Ubp3_3.ricercaCliente(nome, cognome, email);
        if (cliente == null) {
            System.out.print("Cliente non registrato!");
        } else {
            System.out.println("Punti:");
            int punti = Integer.parseInt(scan.nextLine());
            org.example.Ubp3_3.aggiungiPunti(cliente, punti);
    ...
    public static void UC8() throws IOException {
        CodiceSconto codiceSconto;
        System.out.println("Inserisci nuovo codice sconto:\n" +
                "Codice: ");
        String codice = scan.nextLine();
        System.out.println("Percentuale:");
        int percentuale = Integer.parseInt(scan.nextLine());

        codiceSconto = org.example.Ubp3_3.inserisciCodiceSconto(codice, percentuale);
        if (codiceSconto != null) {
            System.out.println(codiceSconto);
            System.out.println("Vuoi confermare il codice inserito? y/n");
            String x = scan.nextLine();
            if (x.equals("y")) {
                org.example.Ubp3_3.confermaCodiceSconto(codiceSconto);
            } else if (x.equals("n")) {
                System.out.println("Inserimento annullato!");
            } else {
                System.out.println("Errore!");
    ...
    public static void UC9() {
        Cliente cliente;
        System.out.println("Inserisci cliente a cui vuoi rimuovere i punti:\n" +
                "Nome: ");
        String nome = scan.nextLine();
        System.out.println("Cognome:");
        String cognome = scan.nextLine();
        ...
        if (cliente == null) {
            ...
            if(cliente.getPunti()<punti){
                System.out.print("Errore!\nI punti del cliente sono inferiori a quelli sottatti!");
                return;
            }
            org.example.Ubp3_3.rimuoviPunti(cliente, punti);
            System.out.print(cliente);
